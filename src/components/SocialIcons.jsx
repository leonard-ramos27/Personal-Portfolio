import { SiFrontendmentor, SiGithub, SiLinkedin, SiGmail  } from "react-icons/si";
...
const SocialIcons = () => {
    return (
        <ul className="flex justify-between items-center gap-[16px]">
            <li>
                <a 
                    href="mailto:ramos27leonard@gmail.com" 
                    target="_blank"
                    className="social-icon transition-all tooltip gmail" 
                    aria-label="Gmail">
                    <SiGmail />
                    <span 
